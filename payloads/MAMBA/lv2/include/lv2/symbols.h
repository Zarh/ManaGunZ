...
#define umd_mutex_offset (0x64480+0x38C)
	...
	/* rebug */
	#define EXPLORE_PLUGIN_REBUG_HASH                   0xACF4AF2B000EC47B
	#define EXPLORE_CATEGORY_GAME_REBUG_HASH            0x9CB378E600056AE5
	#define GAME_EXT_PLUGIN_REBUG_HASH                  0xE274AF7B0001E593
	#define dex_ps2_nonbw_offset                        0xDD9B4
	#define dex_ps2_nonbw_offset2                       0x68324
	#define dex_ps2_nonbw_offset3                       0x17000
	#define dex_ps2tonet_patch                          0xC4E34
	#define dex_ps2tonet_size_patch                     0xC4E28
	#define dex_vmode_patch_offset                      0x4431DC
	#define dex_psp_drm_patch1                          0x242FC0
	#define dex_psp_drm_patch2                          0x243A60
	#define dex_psp_drm_patch3                          0x24369C
	#define dex_psp_drm_patch4                          0x243EA8
	#define dex_psp_drm_patchA                          0x2430DC
	#define dex_psp_drm_patchB                          0x24397C
	#define dex_psp_drm_patchC                          0x242B14
	#define dex_psp_drm_patchD                          0x2430C4
	#define dex_psp_drm_patchE                          0x2430C8
	#define dex_psp_drm_patchF                          0x243A94
	#define dex_psp_extra_drm_patch                     0x245AF0
#endif
