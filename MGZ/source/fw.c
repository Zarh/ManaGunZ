...
u8 init_fw()
{
	   ...
	   ( lv2peek(FW_DATE_OFFSET_421C + 8)==FW_DATE_2_421C) )
	{
		...
		HTAB_PATCH1 = HTAB_PATCH1_421C;
		HTAB_PATCH2 = HTAB_PATCH2_421C;
		HTAB_PATCH3 = HTAB_PATCH3_421C;
	   ...
	   ( lv2peek(FW_DATE_OFFSET_421D + 8)==FW_DATE_2_421D) )
	{
		...
		HTAB_PATCH1 = HTAB_PATCH1_421D;
		HTAB_PATCH2 = HTAB_PATCH2_421D;
		HTAB_PATCH3 = HTAB_PATCH3_421D;
	   ...
	   ( lv2peek(FW_DATE_OFFSET_430C + 8)==FW_DATE_2_430C) )
	{
		...
		HTAB_PATCH1 = HTAB_PATCH1_430C;
		HTAB_PATCH2 = HTAB_PATCH2_430C;
		HTAB_PATCH3 = HTAB_PATCH3_430C;
	   ...
	   ( lv2peek(FW_DATE_OFFSET_430D + 8)==FW_DATE_2_430D) )
	{
		...
		HTAB_PATCH1 = HTAB_PATCH1_430D;
		HTAB_PATCH2 = HTAB_PATCH2_430D;
		HTAB_PATCH3 = HTAB_PATCH3_430D;
	   ...
	   ( lv2peek(FW_DATE_OFFSET_431C + 8)==FW_DATE_2_431C) )
	{
		...
		HTAB_PATCH1 = HTAB_PATCH1_431C;
		HTAB_PATCH2 = HTAB_PATCH2_431C;
		HTAB_PATCH3 = HTAB_PATCH3_431C;
	   ...
	   ( lv2peek(FW_DATE_OFFSET_440C + 8)==FW_DATE_2_440C) )
	{
		...
		HTAB_PATCH1 = HTAB_PATCH1_440C;
		HTAB_PATCH2 = HTAB_PATCH2_440C;
		HTAB_PATCH3 = HTAB_PATCH3_440C;
	   ...
	   ( lv2peek(FW_DATE_OFFSET_441C + 8)==FW_DATE_2_441C) )
	{
		...
		HTAB_PATCH1 = HTAB_PATCH1_441C;
		HTAB_PATCH2 = HTAB_PATCH2_441C;
		HTAB_PATCH3 = HTAB_PATCH3_441C;
	   ...
	   ( lv2peek(FW_DATE_OFFSET_441D + 8)==FW_DATE_2_441D) )
	{
		...
		HTAB_PATCH1 = HTAB_PATCH1_441D;
		HTAB_PATCH2 = HTAB_PATCH2_441D;
		HTAB_PATCH3 = HTAB_PATCH3_441D;
	   ...
	   ( lv2peek(FW_DATE_OFFSET_446C + 8)==FW_DATE_2_446C) )
	{
		...
		HTAB_PATCH1 = HTAB_PATCH1_446C;
		HTAB_PATCH2 = HTAB_PATCH2_446C;
		HTAB_PATCH3 = HTAB_PATCH3_446C;
	   ...
	   ( lv2peek(FW_DATE_OFFSET_446D + 8)==FW_DATE_2_446D) )
	{
		...
		HTAB_PATCH1 = HTAB_PATCH1_446D;
		HTAB_PATCH2 = HTAB_PATCH2_446D;
		HTAB_PATCH3 = HTAB_PATCH3_446D;
	   ...
	   ( lv2peek(FW_DATE_OFFSET_450C + 8)==FW_DATE_2_450C) )
	{
		...
		HTAB_PATCH1 = HTAB_PATCH1_450C;
		HTAB_PATCH2 = HTAB_PATCH2_450C;
		HTAB_PATCH3 = HTAB_PATCH3_450C;
	   ...
	   ( lv2peek(FW_DATE_OFFSET_450D + 8)==FW_DATE_2_450D) )
	{
		...
		HTAB_PATCH1 = HTAB_PATCH1_450D;
		HTAB_PATCH2 = HTAB_PATCH2_450D;
		HTAB_PATCH3 = HTAB_PATCH3_450D;
	   ...
	   ( lv2peek(FW_DATE_OFFSET_453C + 8)==FW_DATE_2_453C) )
	{
		...
		HTAB_PATCH1 = HTAB_PATCH1_453C;
		HTAB_PATCH2 = HTAB_PATCH2_453C;
		HTAB_PATCH3 = HTAB_PATCH3_453C;
	   ...
	   ( lv2peek(FW_DATE_OFFSET_453D + 8)==FW_DATE_2_453D) )
	{
		...
		HTAB_PATCH1 = HTAB_PATCH1_453D;
		HTAB_PATCH2 = HTAB_PATCH2_453D;
		HTAB_PATCH3 = HTAB_PATCH3_453D;
	   ...
	   ( lv2peek(FW_DATE_OFFSET_455C + 8)==FW_DATE_2_455C) )
	{
		...
		HTAB_PATCH1 = HTAB_PATCH1_455C;
		HTAB_PATCH2 = HTAB_PATCH2_455C;
		HTAB_PATCH3 = HTAB_PATCH3_455C;
	   ...
	   ( lv2peek(FW_DATE_OFFSET_455D + 8)==FW_DATE_2_455D) )
	{
		...
		HTAB_PATCH1 = HTAB_PATCH1_455D;
		HTAB_PATCH2 = HTAB_PATCH2_455D;
		HTAB_PATCH3 = HTAB_PATCH3_455D;
	   ...
	   ( lv2peek(FW_DATE_OFFSET_460C + 8)==FW_DATE_2_460C) )
	{
		...
		HTAB_PATCH1 = HTAB_PATCH1_460C;
		HTAB_PATCH2 = HTAB_PATCH2_460C;
		HTAB_PATCH3 = HTAB_PATCH3_460C;
	   ...
	   ( lv2peek(FW_DATE_OFFSET_465C + 8)==FW_DATE_2_465C) )
	{
		...
		HTAB_PATCH1 = HTAB_PATCH1_465C;
		HTAB_PATCH2 = HTAB_PATCH2_465C;
		HTAB_PATCH3 = HTAB_PATCH3_465C;
	   ...
	   ( lv2peek(FW_DATE_OFFSET_465D + 8)==FW_DATE_2_465D) )
	{
		...
		HTAB_PATCH1 = HTAB_PATCH1_465D;
		HTAB_PATCH2 = HTAB_PATCH2_465D;
		HTAB_PATCH3 = HTAB_PATCH3_465D;
	   ...
	   ( lv2peek(FW_DATE_OFFSET_470C + 8)==FW_DATE_2_470C) )
	{
		...
		HTAB_PATCH1 = HTAB_PATCH1_470C;
		HTAB_PATCH2 = HTAB_PATCH2_470C;
		HTAB_PATCH3 = HTAB_PATCH3_470C;
	   ...
	   ( lv2peek(FW_DATE_OFFSET_470D + 8)==FW_DATE_2_470D) )
	{
		...
		HTAB_PATCH1 = HTAB_PATCH1_470D;
		HTAB_PATCH2 = HTAB_PATCH2_470D;
		HTAB_PATCH3 = HTAB_PATCH3_470D;
	   ...
	   ( lv2peek(FW_DATE_OFFSET_475C + 8)==FW_DATE_2_475C) )
	{
		...
		HTAB_PATCH1 = HTAB_PATCH1_475C;
		HTAB_PATCH2 = HTAB_PATCH2_475C;
		HTAB_PATCH3 = HTAB_PATCH3_475C;
	   ...
	   ( lv2peek(FW_DATE_OFFSET_475D + 8)==FW_DATE_2_475D) )
	{
		...
		HTAB_PATCH1 = HTAB_PATCH1_475D;
		HTAB_PATCH2 = HTAB_PATCH2_475D;
		HTAB_PATCH3 = HTAB_PATCH3_475D;
	   ...
	   ( lv2peek(FW_DATE_OFFSET_476C + 8)==FW_DATE_2_476C) )
	{
		...
		HTAB_PATCH1 = HTAB_PATCH1_476C;
		HTAB_PATCH2 = HTAB_PATCH2_476C;
		HTAB_PATCH3 = HTAB_PATCH3_476C;
	   ...
	   ( lv2peek(FW_DATE_OFFSET_476D + 8)==FW_DATE_2_476D) )
	{
		...
		HTAB_PATCH1 = HTAB_PATCH1_476D;
		HTAB_PATCH2 = HTAB_PATCH2_476D;
		HTAB_PATCH3 = HTAB_PATCH3_476D;
	   ...
	   ( lv2peek(FW_DATE_OFFSET_478C + 8)==FW_DATE_2_478C) )
	{
		...
		HTAB_PATCH1 = HTAB_PATCH1_478C;
		HTAB_PATCH2 = HTAB_PATCH2_478C;
		HTAB_PATCH3 = HTAB_PATCH3_478C;
	   ...
	   ( lv2peek(FW_DATE_OFFSET_478D + 8)==FW_DATE_2_478D) )
	{
		...
		HTAB_PATCH1 = HTAB_PATCH1_478D;
		HTAB_PATCH2 = HTAB_PATCH2_478D;
		HTAB_PATCH3 = HTAB_PATCH3_478D;
	   ...
	   ( lv2peek(FW_DATE_OFFSET_480C + 8)==FW_DATE_2_480C) )
	{
		...
		HTAB_PATCH1 = HTAB_PATCH1_480C;
		HTAB_PATCH2 = HTAB_PATCH2_480C;
		HTAB_PATCH3 = HTAB_PATCH3_480C;
	   ...
	   ( lv2peek(FW_DATE_OFFSET_480D + 8)==FW_DATE_2_480D) )
	{
		...
		HTAB_PATCH1 = HTAB_PATCH1_480D;
		HTAB_PATCH2 = HTAB_PATCH2_480D;
		HTAB_PATCH3 = HTAB_PATCH3_480D;
	   ...
	   ( lv2peek(FW_DATE_OFFSET_481C + 8)==FW_DATE_2_481C) )
	{
		...
		HTAB_PATCH1 = HTAB_PATCH1_481C;
		HTAB_PATCH2 = HTAB_PATCH2_481C;
		HTAB_PATCH3 = HTAB_PATCH3_481C;
	   ...
	   ( lv2peek(FW_DATE_OFFSET_481D + 8)==FW_DATE_2_481D) )
	{
		...
		HTAB_PATCH1 = HTAB_PATCH1_481D;
		HTAB_PATCH2 = HTAB_PATCH2_481D;
		HTAB_PATCH3 = HTAB_PATCH3_481D;
	   ...
	   ( lv2peek(FW_DATE_OFFSET_482C + 8)==FW_DATE_2_482C) )
	{
		...
		HTAB_PATCH1 = HTAB_PATCH1_482C;
		HTAB_PATCH2 = HTAB_PATCH2_482C;
		HTAB_PATCH3 = HTAB_PATCH3_482C;
	   ...
	   ( lv2peek(FW_DATE_OFFSET_482D + 8)==FW_DATE_2_482D) )
	{
		...
		HTAB_PATCH1 = HTAB_PATCH1_482D;
		HTAB_PATCH2 = HTAB_PATCH2_482D;
		HTAB_PATCH3 = HTAB_PATCH3_482D;
	   ...
	   ( lv2peek(FW_DATE_OFFSET_483C + 8)==FW_DATE_2_483C) )
	{
		...
		HTAB_PATCH1 = HTAB_PATCH1_483C;
		HTAB_PATCH2 = HTAB_PATCH2_483C;
		HTAB_PATCH3 = HTAB_PATCH3_483C;
	   ...
	   ( lv2peek(FW_DATE_OFFSET_484C + 8)==FW_DATE_2_484C) )
	{
		...
		HTAB_PATCH1 = HTAB_PATCH1_484C;
		HTAB_PATCH2 = HTAB_PATCH2_484C;
		HTAB_PATCH3 = HTAB_PATCH3_484C;
	   ...
	   ( lv2peek(FW_DATE_OFFSET_484D + 8)==FW_DATE_2_484D) )
	{
		...
		HTAB_PATCH1 = HTAB_PATCH1_484D;
		HTAB_PATCH2 = HTAB_PATCH2_484D;
		HTAB_PATCH3 = HTAB_PATCH3_484D;
	   ...
	   ( lv2peek(FW_DATE_OFFSET_485C + 8)==FW_DATE_2_485C) )
	{
		...
		HTAB_PATCH1 = HTAB_PATCH1_485C;
		HTAB_PATCH2 = HTAB_PATCH2_485C;
		HTAB_PATCH3 = HTAB_PATCH3_485C;
	   ...
	   ( lv2peek(FW_DATE_OFFSET_486C + 8)==FW_DATE_2_486C) )
	{
		...
		OFFSET_2_FIX = OFFSET_2_FIX_486C;
		LV2MOUNTADDR_ESIZE = LV2MOUNTADDR_ESIZE_486C;
		LV2MOUNTADDR_CSIZE = LV2MOUNTADDR_CSIZE_486C;
		OFFSET_FIX = OFFSET_FIX_486C;
		HV_START_OFFSET = HV_START_OFFSET_486C;
		OFFSET_FIX_2B17 = OFFSET_FIX_2B17_486C;
		OFFSET_FIX_LIC = OFFSET_FIX_LIC_486C;
		OFFSET_FIX_3C = OFFSET_FIX_3C_486C;
		TOC = TOC_486C;
		SYSCALL_TABLE = SYSCALL_TABLE_486C;
		HTAB_OFFSET = HTAB_OFFSET_486C;
		HTAB_PATCH1 = HTAB_PATCH1_486C;
		HTAB_PATCH2 = HTAB_PATCH2_486C;
		HTAB_PATCH3 = HTAB_PATCH3_486C;
		MMAP_OFFSET1 = MMAP_OFFSET1_486C;
		MMAP_OFFSET2 = MMAP_OFFSET2_486C;
		SPE_OFFSET = SPE_OFFSET_486C;
		LV2MOUNTADDR = LV2MOUNTADDR_486C;
		OPEN_HOOK = OPEN_HOOK_486C;
		BASE_ADDR = BASE_ADDR_486C;
		OFFSET_1_IDPS = OFFSET_1_IDPS_486C;
		OFFSET_2_IDPS = OFFSET_2_IDPS_486C;
		
		PAYLOAD_SKY_SIZE = payload_sky_486C_bin_size;
		PAYLOAD_SKY = (u64) payload_sky_486C_bin;
		UMOUNT_SIZE = umount_486C_bin_size;
		UMOUNT = (u64) umount_486C_bin;
		MAMBA_SIZE = mamba_486C_lz_bin_size;
		MAMBA = (u64) mamba_486C_lz_bin;
		MAMBA_LOADER_SIZE = mamba_loader_486C_bin_size;
		MAMBA_LOADER = (u64 *) mamba_loader_486C_bin;
		ERK_DUMPER_SIZE = erk_dumper_486C_bin_size;
		ERK_DUMPER = (u64 *) erk_dumper_486C_bin;
	   ...
	   ( lv2peek(FW_DATE_OFFSET_487C + 8)==FW_DATE_2_487C) )
	{
		...
		OFFSET_2_FIX = OFFSET_2_FIX_487C;
		LV2MOUNTADDR_ESIZE = LV2MOUNTADDR_ESIZE_487C;
		LV2MOUNTADDR_CSIZE = LV2MOUNTADDR_CSIZE_487C;
		OFFSET_FIX = OFFSET_FIX_487C;
		HV_START_OFFSET = HV_START_OFFSET_487C;
		OFFSET_FIX_2B17 = OFFSET_FIX_2B17_487C;
		OFFSET_FIX_LIC = OFFSET_FIX_LIC_487C;
		OFFSET_FIX_3C = OFFSET_FIX_3C_487C;
		TOC = TOC_487C;
		SYSCALL_TABLE = SYSCALL_TABLE_487C;
		HTAB_OFFSET = HTAB_OFFSET_487C;
		HTAB_PATCH1 = HTAB_PATCH1_487C;
		HTAB_PATCH2 = HTAB_PATCH2_487C;
		HTAB_PATCH3 = HTAB_PATCH3_487C;
		MMAP_OFFSET1 = MMAP_OFFSET1_487C;
		MMAP_OFFSET2 = MMAP_OFFSET2_487C;
		SPE_OFFSET = SPE_OFFSET_487C;
		LV2MOUNTADDR = LV2MOUNTADDR_487C;
		OPEN_HOOK = OPEN_HOOK_487C;
		BASE_ADDR = BASE_ADDR_487C;
		OFFSET_1_IDPS = OFFSET_1_IDPS_487C;
		OFFSET_2_IDPS = OFFSET_2_IDPS_487C;
		
		PAYLOAD_SKY_SIZE = payload_sky_487C_bin_size;
		PAYLOAD_SKY = (u64) payload_sky_487C_bin;
		UMOUNT_SIZE = umount_487C_bin_size;
		UMOUNT = (u64) umount_487C_bin;
		MAMBA_SIZE = mamba_487C_lz_bin_size;
		MAMBA = (u64) mamba_487C_lz_bin;
		MAMBA_LOADER_SIZE = mamba_loader_487C_bin_size;
		MAMBA_LOADER = (u64 *) mamba_loader_487C_bin;
		ERK_DUMPER_SIZE = erk_dumper_487C_bin_size;
		ERK_DUMPER = (u64 *) erk_dumper_487C_bin;
	   ...
	   ( lv2peek(FW_DATE_OFFSET_488C + 8)==FW_DATE_2_488C) )
	{
		...
		OFFSET_2_FIX = OFFSET_2_FIX_488C;
		LV2MOUNTADDR_ESIZE = LV2MOUNTADDR_ESIZE_488C;
		LV2MOUNTADDR_CSIZE = LV2MOUNTADDR_CSIZE_488C;
		OFFSET_FIX = OFFSET_FIX_488C;
		HV_START_OFFSET = HV_START_OFFSET_488C;
		OFFSET_FIX_2B17 = OFFSET_FIX_2B17_488C;
		OFFSET_FIX_LIC = OFFSET_FIX_LIC_488C;
		OFFSET_FIX_3C = OFFSET_FIX_3C_488C;
		TOC = TOC_488C;
		SYSCALL_TABLE = SYSCALL_TABLE_488C;
		HTAB_OFFSET = HTAB_OFFSET_488C;
		HTAB_PATCH1 = HTAB_PATCH1_488C;
		HTAB_PATCH2 = HTAB_PATCH2_488C;
		HTAB_PATCH3 = HTAB_PATCH3_488C;
		MMAP_OFFSET1 = MMAP_OFFSET1_488C;
		MMAP_OFFSET2 = MMAP_OFFSET2_488C;
		SPE_OFFSET = SPE_OFFSET_488C;
		LV2MOUNTADDR = LV2MOUNTADDR_488C;
		OPEN_HOOK = OPEN_HOOK_488C;
		BASE_ADDR = BASE_ADDR_488C;
		OFFSET_1_IDPS = OFFSET_1_IDPS_488C;
		OFFSET_2_IDPS = OFFSET_2_IDPS_488C;
		
		PAYLOAD_SKY_SIZE = payload_sky_488C_bin_size;
		PAYLOAD_SKY = (u64) payload_sky_488C_bin;
		UMOUNT_SIZE = umount_488C_bin_size;
		UMOUNT = (u64) umount_488C_bin;
		MAMBA_SIZE = mamba_488C_lz_bin_size;
		MAMBA = (u64) mamba_488C_lz_bin;
		MAMBA_LOADER_SIZE = mamba_loader_488C_bin_size;
