...
char *STR_DIRECT_BOOT_DESC=NULL;
...
char *STR_SELECT=NULL;
#define STR_SELECT_DEFAULT					"Select"
char *STR_WINDOW=NULL;
...
char *STR_DUMP_ENC=NULL;
#define STR_DUMP_ENC_DEFAULT				"Dump encrypted Blu-Ray disc"
char *STR_DUMP_ENC_DESC=NULL;
#define STR_DUMP_ENC_DESC_DEFAULT			"Get a raw iso of your Blu-Ray disc."
char *STR_DUMP_ERK=NULL;
#define STR_DUMP_ERK_DEFAULT				"Dump eid root key"
char *STR_DUMP_ERK_DESC=NULL;
#define STR_DUMP_ERK_DESC_DEFAULT			"This is the 'main' key to decrypt your system. It's used everywhere. Path: /dev_hdd0/tmp/eid_root_key"
char *STR_DUMP_3DUMP=NULL;
#define STR_DUMP_3DUMP_DEFAULT				"Dump 3Dump.bin"
char *STR_DUMP_3DUMP_DESC=NULL;
#define STR_DUMP_3DUMP_DESC_DEFAULT			"It's the needed file to dump a Blu-Ray with 3k3y IsoTools. Path: /dev_hdd0/tmp/3Dump.bin"
char *STR_SYSTEM_TOOLS=NULL;
#define STR_SYSTEM_TOOLS_DEFAULT			"System tools"
char *STR_DECRYPT_NPDATA=NULL;
#define STR_DECRYPT_NPDATA_DEFAULT			"Decrypt edat/sdat"
char *STR_REDUMP_LOG=NULL;
#define STR_REDUMP_LOG_DEFAULT				"Generate GetKey dump"
char *STR_REDUMP_LOG_DESC=NULL;
#define STR_REDUMP_LOG_DESC_DEFAULT			"Generate files required for redump.org submissions."
char *STR_DUMP_OPTION=NULL;
#define STR_DUMP_OPTION_DEFAULT				"Blu-Ray dumper"
char *STR_IGNORE_ERR=NULL;
#define STR_IGNORE_ERR_DEFAULT				"Ignore errors"
char *STR_IGNORE_ERR_DESC=NULL;
#define STR_IGNORE_ERR_DESC_DEFAULT			"It ignores reading errors during the Blu-Ray dumping process."
char *STR_3K3Y_HEADER=NULL;
#define STR_3K3Y_HEADER_DEFAULT				"Include 3k3y header"
char *STR_3K3Y_HEADER_DESC=NULL;
#define STR_3K3Y_HEADER_DESC_DEFAULT		"It dumps the Blu-ray to an iso with embedded 3k3y header. 3k3y IsoTools will be able to recognize it."
char *STR_ELAPSED=NULL;
#define STR_ELAPSED_DEFAULT					"Elapsed"
char *STR_REMAINING=NULL;
#define STR_REMAINING_DEFAULT				"Remaining"
char *STR_DYNAREC=NULL;
#define STR_DYNAREC_DEFAULT					"Dynarec"
char *STR_DYNAREC_DESC=NULL;
#define STR_DYNAREC_DESC_DEFAULT			"It allows emulators to use dynamic recompilation."
char *STR_BUILD_ISO=NULL;
#define STR_BUILD_ISO_DEFAULT				"Build iso"
char *STR_BUILD_ISO_DESC=NULL;
#define STR_BUILD_ISO_DESC_DEFAULT			"Build a backup iso from Blu-Ray's files."
char *STR_UPLOADER=NULL;
#define STR_UPLOADER_DEFAULT				"Uploader name"
char *STR_UPLOADER_DESC=NULL;
#define STR_UPLOADER_DESC_DEFAULT			"Enter your name if you want credits for your ird uploads, leave it empty to stay anonymous."
char *STR_BOX3D_ALIGN=NULL;
#define STR_BOX3D_ALIGN_DEFAULT				"Align boxes"
char *STR_BOX3D_ALIGN_DESC=NULL;
#define STR_BOX3D_ALIGN_DESC_DEFAULT		"Align game boxes as if it was stored on a shelf."
char *STR_BOX3D_GAP=NULL;
#define STR_BOX3D_GAP_DEFAULT				"Boxes gap"
char *STR_BOX3D_GAP_DESC=NULL;
#define STR_BOX3D_GAP_DESC_DEFAULT			"Adjust the gap between game boxes."
char *STR_SHORT=NULL;
#define STR_SHORT_DEFAULT					"Short"
char *STR_MEDIUM=NULL;
#define STR_MEDIUM_DEFAULT					"Medium"
char *STR_LONG=NULL;
#define STR_LONG_DEFAULT					"Long"
char *STR_MOUNT_BD=NULL;
