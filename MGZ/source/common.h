...
#define TOC_421C                   0x8000000000346390ULL
...
#define TOC_421D                   0x8000000000363E80ULL
...
#define TOC_430C                   0x8000000000348200ULL
...
#define TOC_430D                   0x8000000000365CA0ULL
...
#define TOC_431C                   0x8000000000348210ULL
...
#define TOC_440C                   0x80000000003487D0ULL
...
#define TOC_441C                   0x80000000003487E0ULL
...
#define TOC_441D                   0x80000000003665C0ULL
...
#define TOC_446C                   0x8000000000348DF0ULL
...
#define TOC_446D                   0x8000000000366BD0ULL
...
#define TOC_450C                   0x800000000034B160ULL
...
#define TOC_450D                   0x800000000036EC40ULL
...
#define TOC_453C                   0x800000000034B2E0ULL
...
#define TOC_453D                   0x8000000000370620ULL
...
#define TOC_455C                   0x800000000034E620ULL
...
#define TOC_455D                   0x80000000003738E0ULL
...
#define TOC_460C                   0x800000000034F950ULL
...
#define TOC_465C                   0x800000000034F960ULL
...
#define TOC_465D                   0x8000000000375510ULL
...
#define TOC_470C                   0x800000000034FB10ULL
...
#define TOC_470D                   0x8000000000375850ULL
...
#define TOC_475C                   0x800000000034FBB0ULL
...
#define TOC_475D                   0x80000000003758E0ULL
...
#define TOC_476C                   0x800000000034FBB0ULL
...
#define TOC_476D                   0x80000000003758E0ULL
...
#define TOC_478C                   0x800000000034FBB0ULL
...
#define TOC_478D                   0x80000000003758E0ULL
...
#define TOC_480C                   0x800000000034FBA0ULL
...
#define TOC_480D                   0x80000000003759B0ULL
...
#define TOC_481C                   0x800000000034FBB0ULL
...
#define TOC_481D                   0x80000000003759C0ULL
...
#define TOC_482C                   0x800000000034FBB0ULL
...
#define TOC_482D                   0x80000000003759C0ULL
...
#define TOC_483C                   0x800000000034FBB0ULL
...
#define TOC_484C                   0x800000000034FBB0ULL
...
#define TOC_484D                   0x80000000003759C0ULL
...
#define TOC_485C                   0x800000000034FBB0ULL
...
#define TOC_486C                   0x800000000034FBB0ULL
...
#define OFFSET_FIX_486C            0x05658C
#define OFFSET_2_FIX_486C          0x05A6E4
#define OFFSET_FIX_2B17_486C       0x2275F4
#define OFFSET_FIX_LIC_486C        0x056230
#define OFFSET_FIX_3C_486C         0x267150
#define OPEN_HOOK_486C             0x8000000000297638ULL
#define BASE_ADDR_486C             0x80000000002D8AF0ULL
#define LV2MOUNTADDR_486C          0x8000000000479FC0ULL
#define LV2MOUNTADDR_ESIZE_486C    0x118
#define LV2MOUNTADDR_CSIZE_486C    0x108
...
#define TOC_487C                   0x800000000034FBB0ULL
...
#define OFFSET_FIX_487C            0x05658C
#define OFFSET_2_FIX_487C          0x05A6E4
#define OFFSET_FIX_2B17_487C       0x2275F4
#define OFFSET_FIX_LIC_487C        0x056230
#define OFFSET_FIX_3C_487C         0x267150
#define OPEN_HOOK_487C             0x8000000000297638ULL
#define BASE_ADDR_487C             0x80000000002D8AF0ULL
#define LV2MOUNTADDR_487C          0x8000000000479FC0ULL
#define LV2MOUNTADDR_ESIZE_487C    0x118
#define LV2MOUNTADDR_CSIZE_487C    0x108
#define FW_DATE_OFFSET_487C        0x80000000002FCB68ULL
#define FW_DATE_1_487C             0x323032302F30372FULL
#define FW_DATE_2_487C             0x32322031313A3431ULL
#define OFFSET_1_IDPS_487C         0x80000000003E2E30ULL
#define OFFSET_2_IDPS_487C         0x8000000000474AF4ULL

#define TOC_488C                   0x800000000034FBB0ULL
...
#define OFFSET_FIX_488C            0x05658C
#define OFFSET_2_FIX_488C          0x05A6E4
#define OFFSET_FIX_2B17_488C       0x2275F4
#define OFFSET_FIX_LIC_488C        0x056230
#define OFFSET_FIX_3C_488C         0x267150
#define OPEN_HOOK_488C             0x8000000000297638ULL
#define BASE_ADDR_488C             0x80000000002D8AF0ULL
#define LV2MOUNTADDR_488C          0x8000000000479FC0ULL
#define LV2MOUNTADDR_ESIZE_488C    0x118
#define LV2MOUNTADDR_CSIZE_488C    0x108
#define FW_DATE_OFFSET_488C        0x80000000002FCB68ULL
#define FW_DATE_1_488C             0x323032312F30342FULL
#define FW_DATE_2_488C             0x31322031303A3031ULL
#define OFFSET_1_IDPS_488C         0x80000000003E2E30ULL
#define OFFSET_2_IDPS_488C         0x8000000000474AF4ULL

#define TOC_489C                   0x800000000034FBB0ULL
#define SYSCALL_TABLE_489C         0x8000000000363BE0ULL
#define HV_START_OFFSET_489C       0x370F28
#define HTAB_OFFSET_489C           0x2DD70C
#define HTAB_PATCH1_489C           0x05D5F0
#define HTAB_PATCH2_489C           0x05E028
#define HTAB_PATCH3_489C           0x05E4F0
#define MMAP_OFFSET1_489C          0x2DCF54
#define MMAP_OFFSET2_489C          0x2DD284
#define SPE_OFFSET_489C            0x2F9EB8
#define OFFSET_FIX_489C            0x05658C
#define OFFSET_2_FIX_489C          0x05A6E4
#define OFFSET_FIX_2B17_489C       0x2275F4
#define OFFSET_FIX_LIC_489C        0x056230
#define OFFSET_FIX_3C_489C         0x267150
#define OPEN_HOOK_489C             0x8000000000297638ULL
#define BASE_ADDR_489C             0x80000000002D8AF0ULL
#define LV2MOUNTADDR_489C          0x8000000000479FC0ULL
#define LV2MOUNTADDR_ESIZE_489C    0x118
#define LV2MOUNTADDR_CSIZE_489C    0x108
#define FW_DATE_OFFSET_489C        0x80000000002FCB68ULL
#define FW_DATE_1_489C             0x323032322F30322FULL
#define FW_DATE_2_489C             0x30342031323A3536ULL
