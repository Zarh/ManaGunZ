...
int Search_Offset(char *elf_p, uint8_t type)
{
	...
	if(type == GX) {
		uint8_t payload_addr_FLAG[0x1C] = {0x79, 0x29, 0x80, 0x00, 0x7D, 0x20, 0x01, 0x64, 0x55, 0x60, 0x06, 0x3C, 0x4B, 0xFF, 0xFF, 0x8C, 0x38, 0x60, 0x00, 0x01, 0x4B, 0xFB, 0x32, 0x85, 0x60, 0x00, 0x00, 0x00};
		int n;
